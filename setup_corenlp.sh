...
unzip -qq stanford-corenlp-4.2.2.zip
mv stanford-corenlp-4.2.2 $corenlp_dir

curl https://nlp.stanford.edu/software/stanford-corenlp-4.2.2-models-$lang.jar -o $corenlp_dir/stanford-corenlp-4.2.2-models-$lang.jar
